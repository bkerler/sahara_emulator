...
from usb.usb_cs_interface import USBCSInterface
...
class USBCDCClass(USBClass):
    ...
    def setup_local_handlers(self):
        self.local_handlers = {
            ...
            self.GET_ENCAPSULATED_RESPONSE: self.handle_getter,
            self.SET_COMM_FEATURE: self.handle_setter,
            self.GET_COMM_FEATURE: self.handle_getter,
            ...
            self.GET_ETHERNET_POWER_MANAGEMENT_PATTERN_FILTER: self.handle_getter,
            self.SET_ETHERNET_PACKET_FILTER: self.handle_setter,
            self.GET_ETHERNET_STATISTIC: self.handle_getter,
            self.SET_ATM_DATA_FORMAT: self.handle_setter,
            self.GET_ATM_DEVICE_STATISTICS: self.handle_getter,
            self.SET_ATM_DEFAULT_VC: self.handle_setter,
            self.GET_ATM_VC_STATISTICS: self.handle_getter,
            self.GET_NTB_PARAMETERS: self.handle_getter,
            self.GET_NET_ADDRESS: self.handle_getter,
            self.SET_NET_ADDRESS: self.handle_setter,
            self.GET_NTB_FORMAT: self.handle_getter,
            self.SET_NTB_FORMAT: self.handle_setter,
            self.GET_NTB_INPUT_SIZE: self.handle_getter,
            self.SET_NTB_INPUT_SIZE: self.handle_setter,
            self.GET_MAX_DATAGRAM_SIZE: self.handle_getter,
            self.SET_MAX_DATAGRAM_SIZE: self.handle_setter,
            self.GET_CRC_MODE: self.handle_getter,
